...
void Render::updateAndDisplayBoard(TileInfo tileInfo[],
    ...
    for (int i = 0; i < numOfTiles; i++) {
        if (tileInfo[i].revealed == 0) {
            ...
            if (tileInfo[i].mine != 0) {
                ...
                displayNumOfMines(tileInfo[i], &textureSpriteManager, &window);
...
void Render::displayNumOfMines(TileInfo& tileInfo, TextureSpriteManager& textureSpriteManager, sf::RenderWindow& window, sf::Sprite& numberOfMines) {
