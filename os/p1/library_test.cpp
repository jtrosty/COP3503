...
int tester_main(int argc, char** argv) {
    ...
    cout << "Log level before change: " << get_proc_log_level() << endl;
    cout << "Library set_proc_log_level return output: "
         << set_proc_log_level(3) << endl;
    cout << "Log level after change: " << get_proc_log_level() << endl;
    cout << endl;
    ...
    cout << "Print message with level 2 while in system log level 3 (should "
            "succeed)"
         << endl;
    cout << "Library proc_log_message return output: "
         << proc_log_message(2, const_cast<char*>(message.c_str())) << endl;
    wait_for_dmesg(5);
    re_elevate_privileges();
    ...
    cout << "Print message with level 3 while in system log level 2 (should "
         ...
         << endl;
    cout << "Library proc_log_message return output: "
         << proc_log_message(3, const_cast<char*>(message.c_str())) << endl;
    wait_for_dmesg(5);
    re_elevate_privileges();
    ...
    cout << "Print message with level -1 while in system log level 4 "
         ...
         << endl;
    cout << "Library proc_log_message return output: "
         << proc_log_message(-1, const_cast<char*>(message.c_str())) << endl;
    wait_for_dmesg(5);
    re_elevate_privileges();
    printed = message_in_dmesg(message);
    drop_privileges();
