...
public class Interpreter implements Ast.Visitor<Environment.PlcObject> {
    ...
    public Environment.PlcObject visit(Ast.Stmt.Assignment ast) {
        requireType(Ast.Expr.Access.class, visit )
        throw new UnsupportedOperationException(); //TODO
    }
    ...
    public Environment.PlcObject visit(Ast.Expr.Group ast) {
        return Environment.create(visit(ast.getExpression()));
    }
    ...
    public Environment.PlcObject visit(Ast.Expr.Access ast) {
        if (ast.getReceiver() != null) {
            Environment.PlcObject recieverValue = Environment.create(visit(ast.getReceiver().get()));
            ...
            // a error for if it cannot find the varialbe.

            // The below returnes an enviornment variable, which get value gets the PlcObjec.t
